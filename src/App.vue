<template>
    <div class="container">
        <div class="header-container">
            ...
            <select name="selectComponent" id="selectComponent" v-model="selectedComponent">
                <option
...
export default {
  ...
  computed: {
    getComponents() {
      return this.componentsNames.map((component) => component.slice(3))
    }
  }
}
</script>
